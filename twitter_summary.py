...
def summarize_with_llm(
    ...
    if mlx_path:
        ...
        raw = call_mlx_text(mlx_path, prompt)
...
---
*Generated by twitter_summary.py on {datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M UTC")}*
"""
