...
model, tokenizer = load("/Users/ztomer/MLXModels/OsaurusAI/gemma-4-26B-A4B-it-4bit")

with open("/Users/ztomer/Projects/ztools/.mlx_debug/prompt_7295f2c7.txt", "r") as f:
    prompt = f.read()
