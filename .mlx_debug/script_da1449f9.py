...
model, tokenizer = load("/Users/ztomer/MLXModels/OsaurusAI/Gemma-4-31B-it-JANG_4M")

with open("/Users/ztomer/Projects/ztools/.mlx_debug/prompt_da1449f9.txt", "r") as f:
    prompt = f.read()
