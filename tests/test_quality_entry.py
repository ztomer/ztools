...
class TestRegressionOnly:
    def test_reconstructs_scorecard_with_correct_weights(self):
        ...
        with patch("lib.quality_entry.load_baseline", return_value=baseline), \
    ...
    def test_missing_baseline_shows_message(self):
        import lib.quality_entry as qe
        with patch("lib.quality_entry.load_baseline", return_value={}), \
    ...
    def test_compare_to_baseline_reports_regression(self):
        ...
        prev = _make_scorecard("m", "filename", "c1", [
            ("Relevance", 90, 0.40), ("Format", 80, 0.35), ("Conciseness", 85, 0.25),
        ])
        curr = _make_scorecard("m", "filename", "c1", [
            ("Relevance", 50, 0.40), ("Format", 80, 0.35), ("Conciseness", 85, 0.25),
        ])
